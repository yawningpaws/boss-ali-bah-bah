...
​
 const getNextAvailableCamera = (devices) => {
  // debugger code that I had to write because
  // brother I don't have time to set up dev tools on my phone
  // at this time
  // let allDevices
  // navigator.mediaDevices.enumerateDevices().then((data => allDevices = data ))
  // let videoDevices = devices.filter((device) => {
  //   return device.kind === 'videoinput'
  // })
​
  //const debugCont = document.querySelector('.debugger');
  // videoDevices.forEach((videoDevice) => {
  //   debugCont.innerHTML += `<li>${videoDevice.label}</li>`
  // })
​
